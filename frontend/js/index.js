import { run_json_exported } from "../pkg/fastq2comp_web.js";

function processFile (files) {
    const wasmProcess = new Worker('js/worker.js', { type: "module" }, "another arg");
    ...
    wasmProcess.postMessage ({files: files, run_json_exported: run_json_exported});
}
